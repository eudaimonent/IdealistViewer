...
namespace IdealistViewer.Module
{
    ...
    public class SecondlifeProtocol : IProtocol
    {
        ...
        private void objectKilledCallback(Simulator simulator, uint objectID)
        {
            ...
            {
                OnObjectKilled(new VSimulator(simulator), objectID);
            }
        }
        ...
        private void simConnectedCallback(Simulator sender)
        {
            ...
            {
                OnSimConnected(new VSimulator(sender));
            }
        }
                             ...
                             ushort timeDilation)
        {
            ...
            if (OnNewPrim != null)
            {
                OnNewPrim(new VSimulator(simulator), prim, regionHandle, timeDilation);
            }
        }
        ...
        private void landPatchCallback(Simulator simulator, int x, int y, int width, float[] data)
        {
            if (OnLandPatch != null)
            {
                OnLandPatch(new VSimulator(simulator), x, y, width, data);
            }
        }
                                       ...
                                       ushort timeDilation)
        {
            ...
            {
               //avatar.Velocity
                OnNewAvatar(new VSimulator(simulator), avatar, regionHandle, timeDilation);
            }
        }
                                          ...
                                          ushort timeDilation)
        {
            ...
            {
                OnObjectUpdated(new VSimulator(simulator), update, regionHandle, timeDilation);
            }
        }
