...
{
    /// <summary>
    /// Factory class for constructing meshes for LL primitives.
    /// </summary>
    public class MeshManager
    {
        ...
        public MeshManager(MeshManipulator pmm, IrrlichtDevice pdevice)
        {
            mm = pmm;
            device = pdevice;
        }
        ...
        public Mesh GetSculptMesh(UUID assetid, TextureExtended sculpttex, SculptType stype, Primitive prim)
        {
            ...
            if (result == null)
            {
                ...
                result = PrimMesherG.SculptIrrMesh(bm, (byte)stype);
